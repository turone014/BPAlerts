...
def send_discord_alert(symbol):
    now = datetime.now(ZoneInfo("Asia/Manila")).strftime('%Y-%m-%d %H:%M %Z')
    message = f"""🐻 **Left Hand Alert**

**Symbol**: `{symbol}`
**Time**: {now}

**Conditions Met**:
- 15m RSI(30) between 60–70 ✅
- 5m Price: Higher High ⬆️
- 5m RSI(30): Lower High 🔻
- 5m MACD Line: Lower High 🔻
===================================
"""
    payload = {"content": message}
    response = requests.post(DISCORD_WEBHOOK_URL, json=payload)
...
- 15m Price: Higher High ⬆️
- 15m RSI(30): Lower High 🔻
...
**Conditions Met**:
- 4H RSI(30) between 30–40 ✅
- 1H Price: Lower Low 🔻
- 1H RSI(30): Higher High ⬆️
- 1H MACD Line: Higher High ⬆️
==================================
"""
    payload = {"content": message}
    response = requests.post(DISCORD_WEBHOOK_URL, json=payload)
...
**Conditions Met**:
- 4H RSI(30) between 60–70 ✅
- 1H Price: Higher High ⬆️
- 1H RSI(30): Lower High 🔻
- 1H MACD Line: Lower High 🔻
====================================
"""
    payload = {"content": message}
    response = requests.post(DISCORD_WEBHOOK_URL, json=payload)
